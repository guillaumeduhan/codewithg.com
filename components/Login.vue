...
const switchToSignUp = () => console.log("Switching to Sign Up");
...
<template>
  <div class="grid gap-4 border dark:border-neutral-600 rounded-xl mx-auto max-w-[500px] w-full px-8 py-6 shadow">
    <h1 class="text-center text-3xl font-bold mb-6">Login or Signup</h1>
    <div class="grid gap-2 w-full border-b dark:border-neutral-600 pb-8 mb-6">
    ...
    <div class="grid gap-6">
      ...
      <div class="flex flex-col items-center w-full">
        ...
        <br>
        <div class="text-blue-500 cursor-pointer hover:text-blue-700 text-sm" @click="forgotPassword">
